...
class PreferencesDialog(QDialog):
    ...
    def load_settings(self):
        ...
        self.animation_check.setChecked(
            settings.value("appearance/enable_animations", True, type=bool)
        )
        self.animation_slider.setValue(
            settings.value("appearance/animation_intensity", 50, type=int)
        )
    ...
    def apply_settings(self):
        ...
        settings.setValue(
            "appearance/background_color", getattr(self, "bg_color", QColor(30, 20, 50)).name()
        )
